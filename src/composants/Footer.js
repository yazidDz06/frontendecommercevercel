export default function Footer(){
    return(
        ...
        <footer className="relative z-10 py-28 bg-gradient-to-b from-white to-green-200 sm:pt-16 lg:pt-24" id="foot">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
               

                <p className="text-base leading-relaxed text-gray-600 mt-7">You will find here all links of social media and informations about the website.</p>
                ...
                <ul className="flex items-center space-x-3 mt-9">
                    ...
                    <li>
                        <a href="#" title="" className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fillRule="currentColor">
                                <path
                                    fillRule="evenodd"
                                     clipRule="evenodd"
        ...
        <p className="text-sm text-center text-gray-600">© Copyright 2025, All Rights Reserved by Myshop</p>
    </div>
